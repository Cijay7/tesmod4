...
export default function RecipeGrid({ recipes }) {
  ...
  // ✅ Toggle Favorite
  // ✅ Toggle Favorite (dengan localStorage)
const toggleFavorite = (id) => {
  setFavorites((prev) => {
    ...
    localStorage.setItem('favoriteRecipes', JSON.stringify([...newSet]));
    return newSet;
  });
};
          ...
          return (
            ...
            >
              <div className="relative bg-white/15 backdrop-blur-xl border border-white/25 rounded-2xl md:rounded-3xl overflow-hidden shadow-lg md:shadow-2xl shadow-blue-500/5 hover:shadow-blue-500/15 transition-all duration-500 cursor-pointer group-hover:scale-105 group-hover:bg-white/20">
                ...
                {/* ✨ Overlay saat hover */}
                <div className="absolute inset-0 bg-white/95 backdrop-blur-md text-slate-800 opacity-0 group-hover:opacity-100 transition-opacity duration-500 overflow-y-auto p-4 md:p-6 rounded-2xl">
                  <h4 className="font-bold text-lg mb-2 text-blue-700">Bahan:</h4>
                  ...
                  <h4 className="font-bold text-lg mb-2 text-blue-700">Langkah:</h4>
